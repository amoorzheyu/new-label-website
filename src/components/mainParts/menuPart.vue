...
let { isShowMenu } = storeToRefs(useMenuLayoutStore())
...
<template>
    <div  v-click-outside="clickMenuOutsideEvent">
        <div class="bg-[#fff] text-[#000] px-[18px] py-[10px] rounded-xl">
            <div v-show="false" class="menuItem">
               <div>
                <div>
            ...
            <div v-show="false" class="menuItem">
               <div>
                <div><svg viewBox="0 0 24 24" width="1em" height="1em">
                ...
                <div>
                    <div><svg viewBox="0 0 24 24" width="1em" height="1em">
                        <g fill="none" stroke="currentColor" stroke-width="1.5">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2 7h20M9 14h3m3 0h-3m0 0v-3m0 3v3">
                            </path>
                        </g>
                    </svg></div>
                <div>添加导航</div>
            ...
            <div class="menuItem border-t-[1px] border-[#ccc9]">
               <div>
                <div><svg viewBox="0 0 24 24" width="1em" height="1em">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5">
