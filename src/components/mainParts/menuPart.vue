...
let { isShowMenu,
    ...
    isShowAddClass,
    isShowSetting,
    isShowSwitchTheme, } = storeToRefs(useMenuLayoutStore())
...
<template>
    <div v-click-outside="clickMenuOutsideEvent">
        <div class="bg-[#fff] text-[#000] px-[18px] py-[10px] rounded-xl">
            ...
            <div v-show="isShowAddClass" class="menuItem">
                <div>
                    <div><svg viewBox="0 0 24 24" width="1em" height="1em">
                            <g fill="none" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M13.992 17h3m3 0h-3m0 0v-3m0 3v3"></path>
                                <path
            ...
            <div  v-show="isShowSetting" class="menuItem border-t-[1px] border-[#ccc9]">
                <div>
                    <div><svg viewBox="0 0 24 24" width="1em" height="1em">
                            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="1.5">
