...
const { searchOnFocus, searchOnBlur, getTipListsMess, changeSearchEngine, searchTipsOnClick, searchObtOnClick, clearSearchTextOnClick } = useSearchPartStore();
    ...
    <div>
        ...
        <div v-show="isShowSearch" class="flex justify-center" v-click-outside="searchBarOutClickEvent">
            <div class="w-[1000px] h-[80px] flex justify-center relative">
                ...
                <div><input :placeholder="searchPlaceHolder" @focus="searchFocusEvent" @change="searchChangeEvent"
                        v-model="searchText"
