...
let { searchText, isShowSearchMask, searchEngineIndex,inputDom, searchPlaceHolder, searchEngineName, searchTips, isShowSearchTips, searchEnginesMess, nowSelectedSearchTipsIndex } = storeToRefs(useSearchPartStore());
...
<template>
    <div>
        ...
        <div v-show="isShowSearch" class="flex justify-center " @click="searchBarClickEvent"
            ...
            <div class="w-[1000px] h-[80px] flex justify-center relative">
                <div
                    ...
                    <div class="button-inner-class flex text-[20px] items-center justify-between w-[95px]">
                        <div class="">
                            <!-- <svg data-v-92a36aee="" viewBox="0 0 24 24" width="1em" height="1em" class="text-3xl">
                                <path
                            ...
                            <div v-show="searchEngineIndex == 2"><svg data-v-92a36aee="" viewBox="0 0 24 24" width="1em"
                                    height="1em" class="text-3xl">
                                    <path
                        ...
                        <div>
                            <svg data-v-92a36aee="" viewBox="0 0 24 24" width="1em" height="1em">
                                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" d="m6 9l6 6l6-6"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="button-dropList-item rounded-[32px]  w-[130px] p-[10px] m-1 text-[20px]"
                            ...
                            <div v-show="index == 1">
                                <svg data-v-92a36aee="" viewBox="0 0 24 24" width="1em"
                                    ...
                                    <div v-show="index == 2"><svg data-v-92a36aee="" viewBox="0 0 24 24" width="1em"
                                            height="1em" class="text-3xl">
                                            <path
                                                d="M20.283 10.356h-8.327v3.451h4.792c-.446 2.193-2.313 3.453-4.792 3.453a5.27 5.27 0 0 1-5.279-5.28a5.27 5.27 0 0 1 5.279-5.279c1.259 0 2.397.447 3.29 1.178l2.6-2.599c-1.584-1.381-3.615-2.233-5.89-2.233a8.908 8.908 0 0 0-8.934 8.934a8.907 8.907 0 0 0 8.934 8.934c4.467 0 8.529-3.249 8.529-8.934c0-.528-.081-1.097-.202-1.625z"
                                                fill="currentColor"></path>
                ...
                <div class="">
                    <input ref="inputDom" :placeholder="searchPlaceHolder" @keydown="searchKeyupEvent"
                        @focus="searchFocusEvent" v-model="searchText"
                ...
                <div class="flex justify-center absolute top-[70px] " v-show="isShowSearchTips">
                    <div
                        class="w-[900px] bg-[var(--ground-glass-boardr-color)] backdrop-blur-xl rounded-[26px] shadow-md mt-[20px] p-1">
